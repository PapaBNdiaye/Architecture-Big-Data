...
def create_keyspace(session):
    ...
    print("Keyspace créé avec succès")
...
def create_table(session):
    ...
    print("Table weather_data créée avec succès")
...
def create_spark_connection():
    ...
    try:
        ...
        logger.info("Connexion Spark créée avec succès")
    except Exception as e:
        logger.error(f"Impossible de créer la session Spark: {e}")
...
def connect_to_kafka(spark_conn):
    ...
    try:
        ...
        logger.info("DataFrame Kafka créé avec succès")
    except Exception as e:
        logger.warning(f"DataFrame Kafka ne peut pas être créé: {e}")
...
def create_cassandra_connection():
    ...
    try:
        ...
        logger.info("Connexion Cassandra créée avec succès")
        return cas_session
    except Exception as e:
        logger.error(f"Impossible de créer la connexion Cassandra: {e}")
        return None
    ...
    if spark_conn is not None:
        ...
        if session is not None:
            ...
            try:
                ...
                logger.info("Requête streaming démarrée avec succès")
                ...
                logger.error(f"Échec de la requête streaming: {e}")
